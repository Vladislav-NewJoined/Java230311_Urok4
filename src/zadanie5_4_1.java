public class zadanie5_4_1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ответ на Задание 5: Переменная float задается написанием буквы F (или f) после числового \n значения справа (если с точкой, т.е. если задается дробное число). Она имеет меньший размер памяти (32 bit),\n нежели double (64 bit), поэтому конвертация из float в double происходит автоматически,\n т.н. 'неявным' способом. Пример в коде.");
    }
}